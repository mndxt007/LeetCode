...
public int EvalRPN(string[] tokens)
{
    ...
    return evalStack.FirstOrDefault(0);
}
...
foreach (var tokens in testcases)
{
    Console.WriteLine($"Testcase: tokens-[{String.Join(',', tokens)}]");
    Console.WriteLine($"EvalRPN - {EvalRPN(tokens)}");
}
